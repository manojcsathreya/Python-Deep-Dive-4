...
def MyClass:
    ...
    this is a setter method which we need to assign to the languageproperty
...
def MyClass:
    ...
    lang_prop = language ->store a reference to the languageobject (of type property)
...
make the language symbol refer to the property object again 
    ...
    del lang_prop -> delete lang_prop symbol from namespace
----------------------------------------------------------------------------------------------
...
def MyClass:
    ...
    @language.setter             ->language is now a propertyinstance (an object)
    def language(self, value):   ->we use the settermethod of the languageproperty object
        self._language = value
